      ...
      <section style={{ padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 0.1fr 1fr 0.1fr 1fr", gap: "1rem", margin: "2rem 0", alignItems: "stretch" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", color: "#2968A0", fontSize: "1.8rem", fontWeight: 800 }}>→</div>
            <div style={{ background: "#f4fafc", border: "2px solid #2968A0", borderRadius: 10, padding: "1.5rem", textAlign: "center" }}>
              <div style={{ width: 36, height: 36, background: "#2968A0", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, margin: "0 auto 0.8rem" }}>2</div>
          ...
          {[
            ...
            <div key={title} style={{ background: "#fff", padding: "0.8rem 1rem 0.8rem 2.6rem", border: "1px solid #E3E7EE", borderRadius: 8, marginBottom: "0.6rem", position: "relative" }}>
              <span style={{ position: "absolute", left: "0.9rem", top: "0.8rem", width: "1.4rem", height: "1.4rem", background: "#2968A0", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: "0.85rem" }}>✓</span>
          ...
          {[
            ...
            <blockquote key={who} style={{ background: "#fff", borderLeft: "4px solid #2968A0", padding: "1.2rem 1.5rem", margin: "1rem 0", borderRadius: "0 6px 6px 0", fontStyle: "italic" }}>
              &ldquo;{quote}&rdquo;
