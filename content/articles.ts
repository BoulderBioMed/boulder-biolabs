...
export const articles: Article[] = [
  ...
  {
    slug: "chlorine-dioxide-residuals-2026-framework",
    title: "Chlorine Dioxide Sterilization Residuals: A New 2026 Peer-Reviewed Framework and What It Means for Your Validation",
    description:
    ...
    body: [
      ...
      { type: "p", text: "You can now write a CD validation rationale that cites the 2026 peer-reviewed framework directly, paired with device-specific residuals data from a lab equipped to run the analytical chemistry. Until 2026, that lab list was very short. After 2026, it's still short — but it has Boulder BioLabs on it." },
      { type: "h2", text: "How Boulder BioLabs Helps" },
      { type: "p", text: "We are co-located with Boulder Sterilization, the only U.S. contract sterilizer running CD cycles under ISO 13485. CD residuals testing aligned with the 2026 peer-reviewed framework is offered as a routine service — not an exception." },
  ...
  },
  {
    ...
    datePublished: "2026-05-28",
    author: "Boulder BioLabs",
    related: ["iso-11135-2024-changes", "chlorine-dioxide-residuals-2026-framework", "bioburden-trending-best-practices"],
    body: [
